...
import Rider from "../terms/Rider";
import Driver from "../terms/Driver";
...
export default function TermsClient() {
  ...
  const setRole = (newRole: string) => {
    router.push(`/terms?role=${newRole}`, { scroll: false });
  };
      ...
      <div className="flex flex-col items-center w-full max-w-4xl mb-8 md:mb-12">
        <header className="text-center mb-8 mt-20 md:mt-24">
          ...
          <p className="text-gray-600 text-sm md:text-base px-2">
            يرجى اختيار فئة المستخدم للاطلاع على شروط الاستخدام المناسبة لك.
          </p>
        </header>
